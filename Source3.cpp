...
void average_case()
{
	...
	p.divideValues("comp-ins", NR_TEST);
	p.divideValues("atr-ins", NR_TEST);
	p.divideValues("comp-bub", NR_TEST);
	p.divideValues("atr-bub", NR_TEST);
	p.divideValues("comp-sel", NR_TEST);
	p.divideValues("atr-sel", NR_TEST);
		
	p.addSeries("total-bub", "comp-bub", "atr-bub");
	p.addSeries("total-sel", "comp-sel", "atr-sel");
	p.addSeries("total-ins", "comp-ins", "atr-ins");
	p.createGroup("average-case-total", "total-bub", "total-sel", "total-ins");
	p.createGroup("average-case-comp", "comp-bub", "comp-sel", "comp-ins");
	p.createGroup("average-case-atr", "atr-bub", "atr-ins","atr-sel");
	p.showReport();
}
int main()
{
